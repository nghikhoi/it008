...
namespace UI.Components
{
    ...
    public partial class ThumbnailBubble : UserControl {
        ...
        public static readonly DependencyProperty MediaInfoProperty = DependencyProperty.Register(nameof(MediaInfo), typeof(MediaInfo)
            , typeof(ThumbnailBubble), new FrameworkPropertyMetadata(null));
